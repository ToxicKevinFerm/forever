// Regenerates the spell store, sim/<class>/spell_data_auto_gen.go, the hunter's
// pet_families_auto_gen.go and ammo_auto_gen.go, and the raid buffs from the client database.
//
